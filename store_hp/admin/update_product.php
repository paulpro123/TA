...
if(isset($_POST['update'])){
   ...
   $update_product = $koneksi->prepare("UPDATE `products` SET name = ?, price = ?, details = ? WHERE id = ?");
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         $update_image_01 = $koneksi->prepare("UPDATE `products` SET image_01 = ? WHERE id = ?");
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         $update_image_02 = $koneksi->prepare("UPDATE `products` SET image_02 = ? WHERE id = ?");
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         $update_image_03 = $koneksi->prepare("UPDATE `products` SET image_03 = ? WHERE id = ?");
