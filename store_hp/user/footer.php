<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="kontak.php"> <i class="fas fa-angle-right"></i> contact</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="keranjang.php"> <i class="fas fa-angle-right"></i> keranjang</a>
      ...
      <div class="box">
         ...
         <a href="#"><i class="fas fa-envelope"></i>faulgtg@gmail.com</a>
         <a href="#"><i class="fas fa-map-marker-alt"></i> Malang, indonesia - 185421 </a>
      </div>
